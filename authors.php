...
<section class="authors">
   ...
   <div class="box">
      ...
      <p>Total Post : <span><?= $total_admin_posts; ?></span></p>
      <p>Total Likes : <span><?= $total_admin_likes; ?></span></p>
      <p>Total Comments : <span><?= $total_admin_comments; ?></span></p>
      <a href="author_posts.php?author=<?= $fetch_authors['name']; ?>" class="btn">See content</a>
   </div>

   <?php }
   }else{
      echo '<p class="empty">There are currently no authors listed!</p>';
   } ?>
