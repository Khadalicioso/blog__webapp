...
<header class="header">
   ...
   <div class="profile">
      ...
      <a href="update_profile.php" class="btn">Update Account Information</a>
   </div>
   <nav class="navbar">
      ...
      <a href="../components/admin_logout.php" style="color:var(--red);" onclick="return confirm('Log Out?');"><i class="fas fa-right-from-bracket"></i><span>Logout</span></a>
   </nav>
   <div class="flex-btn">
