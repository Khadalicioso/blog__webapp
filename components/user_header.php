...
<header class="header">
   <section class="flex">
      <a href="home.php" class="logo">The Curious Mind</a>
      ...
      <nav class="navbar">
         ...
         <a href="authors.php"> <i class="fas fa-angle-right"></i> Author </a>
      ...
      <div class="profile">
         ...
         <a href="components/user_logout.php" onclick="return confirm('Log out?');" class="delete-btn">Logout</a>

         <?php
            }else{
         ?>

            <p class="name">Please log in to your account!</p>
            <a href="login.php" class="option-btn">Login</a>
