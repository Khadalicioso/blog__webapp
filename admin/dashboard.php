...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <p>Active Post</p>
      <a href="view_posts.php" class="btn">See Post</a>
   </div>
   <div class="box">
   ...
   <div class="box">
      ...
      <p>User</p>
      <a href="users_accounts.php" class="btn">See User</a>
   </div>
   <div class="box">
   ...
   <div class="box">
      ...
      <p>Comment</p>
      <a href="comments.php" class="btn">See Comment</a>
   </div>
   <div class="box">
