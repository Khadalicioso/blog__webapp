...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Title <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Title for your Content" class="box" value="<?= $fetch_posts['title']; ?>">
      ...
      <select name="category" class="box" required>
         ...
         <option value="short stories">pShort Stories</option>
      ...
      <div class="flex-btn">
         ...
         <a href="view_posts.php" class="option-btn">Back</a>
   ...
   <?php
         ...
         echo '<p class="empty">Your search did not yield any results!</p>';
   ?>
