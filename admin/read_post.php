...
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="flex-btn">
         ...
         <a href="view_posts.php" class="inline-option-btn">Back</a>
      </div>
   </form>
   ...
   <?php
         ...
         echo '<p class="empty">There are currently no posts! <a href="add_posts.php" class="btn" style="margin-top:1.5rem;">Add Post</a></p>';
      }
   ?>
