...
?>
   ...
   <form action="" method="POST">
      ...
      <textarea name="comment_edit_box" required cols="30" rows="10" placeholder="Enter your Comment"><?= $fetch_edit_comment['comment']; ?></textarea>
...
<section class="comments-container">
   <h1 class="heading">Your Comment</h1>
   <p class="comment-title">Your comments about the post</p>
   <div class="user-comments-container">
      ...
      <?php
            ...
            echo '<p class="empty">There are currently no comments!</p>';
         }
      ?>
